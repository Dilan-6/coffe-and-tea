...
public class InventarioView {
    ...
    public void mostrarInventario() {
        ...
        String IngresoStock, IngresoStockMin, IngresoPrecio, continuar = "", modificacionOp = "";
       ...
       do
       {
            ...
            case 2: 
        {
            ...
            modificacionOp = JOptionPane.showInputDialog("¿Qué producto quiere modificar? \n" + lista);
            
            if (modificacionOp == null)
            {
            ...
            {
                modificarOpcion = Integer.parseInt(modificacionOp);
            }

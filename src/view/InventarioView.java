...
public class InventarioView {
    ...
    public void mostrarInventario() {
        ...
        String confirmacion = "", lista = "", modificacion = "", nuevoNombre = "", nuevoStock = "", nuevoMin = "",
                nuevoPrecio = "";
            ...
            switch (opcion) {
                case 1:
                    for (int i = contador; i < max_producto; i++) {
                        ...
                        } while (IngresoStock == null || IngresoStock.trim().equals("") || !IngresoStock.matches("\\d+")
                                || stock_actual[i] < 0);
                        ...
                        } while (IngresoStockMin == null || IngresoStockMin.trim().equals("")
                                || !IngresoStockMin.matches("\\d+") || stock_minimo[i] < 0);
                        ...
                        } while (IngresoPrecio == null || IngresoPrecio.trim().equals("")
                                || !IngresoPrecio.matches("\\d+(\\.\\d+)?") || precio_unitario[i] < 0);
                ...
                case 2: {
                    ...
                    ficha_producto[modificarOpcion] = "Nombre: " + nombre_producto[modificarOpcion] + "\n" +
                    ...
                    break;
                case 3:
                    JOptionPane.showMessageDialog(null, "Volviendo a la pantalla principal");
                    break;
            }
